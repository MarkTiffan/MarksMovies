...
namespace MarksMovies.API
{
    ...
    public class MovieController : ControllerBase
    {
        ...
        /// <param name="Title">The title of the fetched movie</param>
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<Movie>> ImportMovieAsync(int TMDB_ID, string Title, [FromBody] Movie Movie = null)
        {
            if (Movie == null)
                Movie = new Movie();
            ...
            var result = await _createService.ImportMovieAsync(TMDB_ID, Title, Movie);
            if (result == null)
                return NotFound();
            else
                return Ok(result);
